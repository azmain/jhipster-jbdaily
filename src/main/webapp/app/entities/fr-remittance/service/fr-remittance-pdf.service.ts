  ...
  convertDateFromServer(frRemittance: IFrRemittance): TDocumentDefinitions {
    ...
    let frRemittanceVoucherPrint: TDocumentDefinitions = {
      content: [
        ...
        {
          canvas: [{ type: 'line', x1: 0, y1: 10, x2: 510, y2: 10, dash: { length: 5, space: 5 } }],
        },

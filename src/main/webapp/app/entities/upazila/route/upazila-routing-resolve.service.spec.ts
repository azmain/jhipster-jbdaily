...
describe('Upazila routing resolve service', () => {
  ...
  let resultUpazila: IUpazila | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IUpazila returned by find', () => {
      ...
      expect(resultUpazila).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultUpazila).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IUpazila>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
